...
def get_arguments():
    ...
    # Dataset
    parser.add_argument("--datadir", type=str, default="/Users/kipyokim/EffiSeg/src/data/cityscapes", help="Path to the directory containing the dataset")
    ...
    parser.add_argument("--load_pretrained", type=bool, default=True, help="Load pretrained weights for the model")
    ...
    parser.add_argument("num_train_epochs", type=int, default=500, help="Number of epochs to train the model")
